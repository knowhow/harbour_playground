/*
 * $Id: wx_MessageDialog.cpp 743 2011-07-27 18:26:08Z tfonrouge $
 */
...
HB_FUNC( WXMESSAGEDIALOG_NEW )
{
    ...
    const wxString& caption = HB_ISNIL( 3 ) ? wxString( _T("Message box") ) : wxh_parc( 3 );
    long style = HB_ISNIL( 4 ) ? wxOK | wxCANCEL : hb_parni( 4 );
